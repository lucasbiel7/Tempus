...
public class Relatorios {
    ...
    public Relatorios(String nome, Map<String, Object> parametros) {
        ...
        try {
            JasperPrint jasperPrint = JasperFillManager.fillReport(getClass().getResourceAsStream("/br/com/QuadroDeHorario/view/report/" + nome + ".jasper"), parametros, new JREmptyDataSource());
    ...
    public Relatorios(String nome, Map<String, Object> parametros, TableModel tableModel) {
        ...
        try {
            JasperPrint jasperPrint = JasperFillManager.fillReport(getClass().getResourceAsStream("/br/com/QuadroDeHorario/view/report/" + nome + ".jasper"), parametros, new JRTableModelDataSource(tableModel));
            painelRelatorio = new PainelRelatorio(jasperPrint, Locale.ROOT);
        } catch (JRException e) {
            System.err.println(e.getMessage());
        }
